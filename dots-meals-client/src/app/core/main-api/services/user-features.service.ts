...
export class UserFeaturesService extends BaseService {
   ...
   */
  userRetrieveLoggedUserEndpoint$Response(params?: UserRetrieveLoggedUserEndpoint$Params, context?: HttpContext): Observable<StrictHttpResponse<UserRetrieveLoggedUserResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  userRetrieveLoggedUserEndpoint(params?: UserRetrieveLoggedUserEndpoint$Params, context?: HttpContext): Observable<UserRetrieveLoggedUserResponse> {
    return this.userRetrieveLoggedUserEndpoint$Response(params, context).pipe(
      map((r: StrictHttpResponse<UserRetrieveLoggedUserResponse>): UserRetrieveLoggedUserResponse => r.body)
    );
  }
